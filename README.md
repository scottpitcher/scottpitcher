...
An ML Engineer with interests in research and model development, especially within language models and predictive forecasting! I never saw myself working with code, until I completed my first year in college; I now have 3+ years of learning and working with Python, R, SQL, and more! As I navigate my next steps, I'll be working on cool new projects here! 🔜
